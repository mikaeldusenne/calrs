...
slots-load-error = Não foi possível carregar a disponibilidade. Tente novamente.
slots-unverified = Não foi possível verificar a disponibilidade. Tente novamente mais tarde.
slots-retry = Tentar novamente
...
# Background synchronization: English copy pending locale translation.
sync-heading = Synchronization status
sync-state-idle = Not synchronized yet
sync-state-queued = Queued
sync-state-running = Synchronization in progress
sync-state-ok = Calendar verified
sync-state-failed = Synchronization failed
sync-background-note = This page refreshes automatically. You may close it; synchronization continues in the background (maximum 3 minutes).
sync-stage = Last stage reached
sync-elapsed = Duration
sync-reference = Diagnostic reference
sync-last-verified = Last complete verification
sync-never = never
sync-back = Back to calendars
sync-setup-write = Choose the calendar for new bookings
sync-failed-note = The previous complete calendar is kept. Booking availability is withheld until verification succeeds. Share only the reference, stage, duration and error code with your administrator.
sync-stage-queued = Waiting for a worker
sync-stage-credentials = Preparing authentication
sync-stage-discover-principal = Discovering the account
sync-stage-discover-calendar-home = Discovering the calendar location
sync-stage-list-calendars = Listing calendars
sync-stage-inventory = Listing event versions
sync-stage-download-events = Downloading changed events
sync-stage-verify-calendar-state = Checking snapshot consistency
sync-stage-commit-snapshot = Saving the complete calendar
sync-stage-response-headers = Waiting for the calendar server
sync-stage-response-body = Receiving the calendar server response
sync-error-deadline = The 3-minute job deadline was exceeded.
sync-error-timeout = The calendar server took too long to respond.
sync-error-connect = Unable to connect to the calendar server. Check DNS, network and TLS.
sync-error-http-status = The calendar server rejected the request. 401/403: check authentication or permissions; 5xx: check DavMail/Exchange.
sync-error-invalid-response = The server returned an invalid or incomplete CalDAV response.
sync-error-remote-changed = The calendar changed during synchronization. Retry.
sync-error-no-calendars = No usable calendar was returned. Check the account and its permissions.
sync-error-database = The local calendar could not be saved. Check database access and disk space.
sync-error-interrupted = The synchronization was interrupted, possibly by a server restart. Retry.
sync-error-invalid-calendar = An event cannot be read safely. No partial calendar was published.
sync-error-invalid-recurrence = An event has an invalid recurrence rule.
sync-error-unsupported-recurrence = A recurrence format cannot yet be handled safely.
sync-error-unsupported-timezone = An event uses an unsupported timezone.
sync-error-unsupported-duration = An event uses a duration that cannot be read safely.
sync-error-response-too-large = The server response exceeds the 16 MiB safety limit.
sync-error-snapshot-too-large = The calendar exceeds the 64 MiB safety limit.
...
# Private synchronization failure report (English pending translation)
