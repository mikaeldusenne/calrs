...
slots-load-error = Die Verfügbarkeit konnte nicht geladen werden. Bitte versuche es erneut.
slots-unverified = Die Verfügbarkeit konnte nicht geprüft werden. Bitte versuche es später erneut.
