...
slots-load-error = No se ha podido cargar la disponibilidad. Inténtalo de nuevo.
slots-unverified = No se ha podido verificar la disponibilidad. Inténtalo de nuevo más tarde.
slots-retry = Reintentar
slots-week-more = más
